...
#endif
#ifdef	__BF3925_DRV_C__
extern void BF3925_Init (INT16S nWidthH, INT16S nWidthV, INT16U uFlag);
#endif
...
#ifdef	__BF3925_DRV_C__
//====================================================================================================
//	Description:	BF3925 Initialization
//	Syntax:			void BF3925_Init (
//						INT16S nWidthH,			// Active H Width
//						INT16S nWidthV,			// Active V Width
//						INT16U uFlag				// Flag Type
//					);
...
)
{
    ...
    sccb_delay (200);
    {
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0xf2, 0x01);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x50, 0x00);
        sccb_write(SLAVE_ID, 0x51, 0x00);
        sccb_write(SLAVE_ID, 0xe0, 0x00);
        sccb_write(SLAVE_ID, 0xe2, 0x64);
        sccb_write(SLAVE_ID, 0xe3, 0x48);
        sccb_write(SLAVE_ID, 0xe4, 0x81);
        sccb_write(SLAVE_ID, 0xe9, 0x18);//2a  08:48m  09:24m 18:60m  19:30m 2a:72m 2b:36m
        sccb_write(SLAVE_ID, 0xe7, 0x80);//3.2
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x01, 0x00);
        sccb_write(SLAVE_ID, 0x02, 0x20);
        sccb_write(SLAVE_ID, 0x03, 0x02); //0a
        sccb_write(SLAVE_ID, 0x04, 0x00);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0xe5, 0x32);
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x05, 0xa8);
        sccb_write(SLAVE_ID, 0x3c, 0x97);
        sccb_write(SLAVE_ID, 0x09, 0xa4);
        sccb_write(SLAVE_ID, 0x0a, 0xac);
        sccb_write(SLAVE_ID, 0x0b, 0x50);
        sccb_write(SLAVE_ID, 0x0c, 0xf4);
        sccb_write(SLAVE_ID, 0x0d, 0xcc);
        sccb_write(SLAVE_ID, 0x0e, 0x30);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x52, 0x00);
        sccb_write(SLAVE_ID, 0x5d, 0x02);
        sccb_write(SLAVE_ID, 0x5a, 0x00);
        sccb_write(SLAVE_ID, 0x5b, 0x00);
        sccb_write(SLAVE_ID, 0x5c, 0x00);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x53, 0x50);
        sccb_write(SLAVE_ID, 0x54, 0x20);
        sccb_write(SLAVE_ID, 0x55, 0x00);
        sccb_write(SLAVE_ID, 0x56, 0x00);
        sccb_write(SLAVE_ID, 0x57, 0x00);
        sccb_write(SLAVE_ID, 0x58, 0xd0);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x50, 0x00);
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0xb2, 0x81);
        sccb_write(SLAVE_ID, 0xb0, 0x16);
        sccb_write(SLAVE_ID, 0xb1, 0x1d);
        sccb_write(SLAVE_ID, 0xb2, 0x89);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x00, 0x00);
        sccb_write(SLAVE_ID, 0x0e, 0x0a);
        sccb_write(SLAVE_ID, 0x0f, 0x64);
        sccb_write(SLAVE_ID, 0x10, 0x28);
        sccb_write(SLAVE_ID, 0x00, 0x05);//05//00
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0xe1, 0x28);
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x00, 0x47);
        sccb_write(SLAVE_ID, 0x18, 0x0c);
        sccb_write(SLAVE_ID, 0x19, 0x1a);
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x52, 0x13);
        sccb_write(SLAVE_ID, 0x53, 0x5c);
        sccb_write(SLAVE_ID, 0x54, 0x24);
        sccb_write(SLAVE_ID, 0x55, 0x13);
        sccb_write(SLAVE_ID, 0x56, 0x5c);
        sccb_write(SLAVE_ID, 0x57, 0x24);
        sccb_write(SLAVE_ID, 0x58, 0xd3);
        sccb_write(SLAVE_ID, 0x59, 0x5c);
        sccb_write(SLAVE_ID, 0x5a, 0x24);
        sccb_write(SLAVE_ID, 0x5b, 0x0f);
        sccb_write(SLAVE_ID, 0x5c, 0x0a);
        sccb_write(SLAVE_ID, 0x5d, 0x0a);
        sccb_write(SLAVE_ID, 0x5e, 0x0a);
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x60, 0x30);//30//50//40//28//40//24
        sccb_write(SLAVE_ID, 0x61, 0x28);//2a//40//38//26//38//30
        sccb_write(SLAVE_ID, 0x62, 0x24);//24//28//30//24//30//24
        sccb_write(SLAVE_ID, 0x63, 0x1f);//1a//20//28//22//28//1d
        sccb_write(SLAVE_ID, 0x64, 0x1b);//1a//18//20//1c//20//1a
        sccb_write(SLAVE_ID, 0x65, 0x18);//18//16//16//19//16//14
        sccb_write(SLAVE_ID, 0x66, 0x17);//16//12//12//15//12//11
        sccb_write(SLAVE_ID, 0x67, 0x15);//14//10//0d//11//0d//0e
        sccb_write(SLAVE_ID, 0x68, 0x12);//10//0d//0b//0f//0b//0d
        sccb_write(SLAVE_ID, 0x69, 0x10);//0e//0b//0a//0e//0a//0c
        sccb_write(SLAVE_ID, 0x6a, 0x0c);//0d//09//08//0c//08//0b
        sccb_write(SLAVE_ID, 0x6b, 0x0b);//0a//08//07//0a//07//09
        sccb_write(SLAVE_ID, 0x6c, 0x05);//06//07//05//09//05//09
        sccb_write(SLAVE_ID, 0x6d, 0x02);//04//04//03//08//03//08
        sccb_write(SLAVE_ID, 0x6e, 0x01);//02//02//02//04//02//07
        sccb_write(SLAVE_ID, 0x6f, 0xf0);
        sccb_write(SLAVE_ID, 0x70, 0x40);//0403
        sccb_write(SLAVE_ID, 0x71, 0x60);//0402 0x00
        sccb_write(SLAVE_ID, 0x72, 0x20);
        sccb_write(SLAVE_ID, 0x73, 0x20);
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x80, 0x0f);
        sccb_write(SLAVE_ID, 0x81, 0x0c);
        sccb_write(SLAVE_ID, 0x83, 0x29);//37
        sccb_write(SLAVE_ID, 0x84, 0xe6);
        sccb_write(SLAVE_ID, 0x85, 0x88);
        sccb_write(SLAVE_ID, 0x86, 0xfd);
        sccb_write(SLAVE_ID, 0x87, 0x1a);
        sccb_write(SLAVE_ID, 0x88, 0xa8);//88
        sccb_write(SLAVE_ID, 0x89, 0xca);
        sccb_write(SLAVE_ID, 0x8b, 0x12);//13//12
        sccb_write(SLAVE_ID, 0x91, 0x45);
        sccb_write(SLAVE_ID, 0x93, 0x0c);//14//0c
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0xa2, 0x10); //06//¨m?©¤©° ©¸?¡è©Ð¡è?
        sccb_write(SLAVE_ID, 0xa3, 0x28);
        sccb_write(SLAVE_ID, 0xa4, 0x08);	//0a
        sccb_write(SLAVE_ID, 0xa5, 0x30); //22
        sccb_write(SLAVE_ID, 0xa7, 0x1b);
        sccb_write(SLAVE_ID, 0xa8, 0x14);
        sccb_write(SLAVE_ID, 0xa9, 0x18);	//18//15   //©¸?¨§?¨ª¨¢
        sccb_write(SLAVE_ID, 0xaa, 0x18);	//16//18   //¨Uy¨§?¨ª¨¢
        sccb_write(SLAVE_ID, 0xab, 0x1e);//14//26
        sccb_write(SLAVE_ID, 0xac, 0x4c);//4c//6c//5c
        sccb_write(SLAVE_ID, 0xad, 0xff); //add
        sccb_write(SLAVE_ID, 0xae, 0x47);
        sccb_write(SLAVE_ID, 0xb2, 0x89);
        sccb_write(SLAVE_ID, 0xb3, 0x66); //55	//66
        sccb_write(SLAVE_ID, 0xb4, 0x00);//09
        sccb_write(SLAVE_ID, 0xb5, 0x09);
        sccb_write(SLAVE_ID, 0xb6, 0xd9);
        sccb_write(SLAVE_ID, 0xb8, 0xca);
        sccb_write(SLAVE_ID, 0xbb, 0x0d);	//10 //0d¨[?¨T? ¨X¡è¡è?©¸?
        sccb_write(SLAVE_ID, 0xbc, 0x14); //16 //12//¨[?¨T? ¨X¡è¡è?©¸?
        sccb_write(SLAVE_ID, 0xbd, 0x14); //09
        sccb_write(SLAVE_ID, 0xbe, 0x28); //23
        sccb_write(SLAVE_ID, 0xbf, 0x66);
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0xc0, 0x89);	//8e	//8b	//03//03  //¨m?©¤©°
        sccb_write(SLAVE_ID, 0xc1, 0x82);	//85//01	//8b//8e
        sccb_write(SLAVE_ID, 0xc2, 0x86);	//86//88
        sccb_write(SLAVE_ID, 0xc3, 0x8f);	//86	//88//92
        sccb_write(SLAVE_ID, 0xc4, 0x84);	//02
        sccb_write(SLAVE_ID, 0xc5, 0x8a);	//82
        sccb_write(SLAVE_ID, 0xc6, 0x8a);
        sccb_write(SLAVE_ID, 0xc7, 0x82);
        sccb_write(SLAVE_ID, 0xc8, 0x8b);
        sccb_write(SLAVE_ID, 0xc9, 0x87);
        sccb_write(SLAVE_ID, 0xca, 0x83);
        sccb_write(SLAVE_ID, 0xcb, 0x91);
        sccb_write(SLAVE_ID, 0xcd, 0x3f); //0402
        sccb_write(SLAVE_ID, 0xd0, 0x89);//8a//8e //03	//95//¨m?¨T?//01
        sccb_write(SLAVE_ID, 0xd1, 0x82);//82//02 //8b //00//85
        sccb_write(SLAVE_ID, 0xd2, 0x86);//89//88 //86 //82
        sccb_write(SLAVE_ID, 0xd3, 0x87);//8a//8b //86 //88
        sccb_write(SLAVE_ID, 0xd4, 0x84);//04//02 //02 //83
        sccb_write(SLAVE_ID, 0xd5, 0x8a);//8f//8d //82 //99
        sccb_write(SLAVE_ID, 0xd6, 0x61); //61//41 disable outdoor color
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x00, 0x05);
        sccb_write(SLAVE_ID, 0x01, 0x88);//8a
        sccb_write(SLAVE_ID, 0x04, 0x38); //42  3a
        sccb_write(SLAVE_ID, 0x05, 0x48);
        sccb_write(SLAVE_ID, 0x07, 0x92);
        sccb_write(SLAVE_ID, 0x09, 0x84); //85
        sccb_write(SLAVE_ID, 0x0b, 0x82);
        sccb_write(SLAVE_ID, 0x0c, 0xbf);//bf  e5
        sccb_write(SLAVE_ID, 0x0d, 0xa0);
        sccb_write(SLAVE_ID, 0x15, 0x42);	//42
        sccb_write(SLAVE_ID, 0x17, 0xb4);	//b4	//b3 ¨m?©¤©°¨m?¨T?©Ø©Ø?¨^¨§?¨ª¨¢
        sccb_write(SLAVE_ID, 0x18, 0x60);	//60	//a0
        sccb_write(SLAVE_ID, 0x19, 0x9a);
        sccb_write(SLAVE_ID, 0x1b, 0x38);//3.3 33//40
        sccb_write(SLAVE_ID, 0x1c, 0x70);//3.3 66//80
        sccb_write(SLAVE_ID, 0x1d, 0x55);
        sccb_write(SLAVE_ID, 0x1e, 0x80);
        sccb_write(SLAVE_ID, 0x1f, 0xcc);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x30, 0xd0);
        sccb_write(SLAVE_ID, 0x31, 0x48);
        sccb_write(SLAVE_ID, 0x32, 0x00);
        sccb_write(SLAVE_ID, 0x33, 0x80);
        sccb_write(SLAVE_ID, 0x34, 0xc8);	//©¸? ??¨U¨T?¨^
        sccb_write(SLAVE_ID, 0x35, 0xb8); //f8 //¨Uy ??¨U¨T?¨^
        sccb_write(SLAVE_ID, 0x36, 0xff);
        sccb_write(SLAVE_ID, 0x37, 0xd0);
        sccb_write(SLAVE_ID, 0x38, 0x43);
        sccb_write(SLAVE_ID, 0x3b, 0x08);//08
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x3e, 0x01); //82//02
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x05, 0xe8);
        sccb_write(SLAVE_ID, 0x19, 0x17);
        sccb_write(SLAVE_ID, 0x1d, 0x50);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x0b, 0x81);
        sccb_write(SLAVE_ID, 0xe2, 0x64);//3.3 a4  64
        sccb_write(SLAVE_ID, 0xe3, 0xc8);//3.2
        sccb_write(SLAVE_ID, 0xe5, 0x30);//3.3 00
        sccb_write(SLAVE_ID, 0x3f, 0x18);//25
        sccb_write(SLAVE_ID, 0x40, 0x40);//40
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x72, 0x20); //20//3.3 1c 0402
        sccb_write(SLAVE_ID, 0x73, 0x20); //20//3.3 1c 0402
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x60, 0x30);
        sccb_write(SLAVE_ID, 0x61, 0x2a);
        sccb_write(SLAVE_ID, 0x62, 0x24);
        sccb_write(SLAVE_ID, 0x63, 0x1a);
        sccb_write(SLAVE_ID, 0x64, 0x1a);
        sccb_write(SLAVE_ID, 0x65, 0x18);
        sccb_write(SLAVE_ID, 0x66, 0x16);
        sccb_write(SLAVE_ID, 0x67, 0x14);
        sccb_write(SLAVE_ID, 0x68, 0x12);
        sccb_write(SLAVE_ID, 0x69, 0x0e);
        sccb_write(SLAVE_ID, 0x6a, 0x0b);
        sccb_write(SLAVE_ID, 0x6b, 0x08);
        sccb_write(SLAVE_ID, 0x6c, 0x07);
        sccb_write(SLAVE_ID, 0x6d, 0x04);
        sccb_write(SLAVE_ID, 0x6e, 0x02);
        sccb_write(SLAVE_ID, 0x70, 0x40);
        sccb_write(SLAVE_ID, 0x6f, 0x30);
        sccb_write(SLAVE_ID, 0xff, 0x01);
        sccb_write(SLAVE_ID, 0x16, 0x8a);
        sccb_write(SLAVE_ID, 0xff, 0x00);
        sccb_write(SLAVE_ID, 0x88, 0xa8);
        sccb_write(SLAVE_ID, 0x8b, 0x13);
        sccb_write(SLAVE_ID, 0x91, 0x45);
    }
...
)
{
    ...
    //	sccb_write(SLAVE_ID,0x12,0x80);	//wwj mark
    sccb_write(SLAVE_ID, 0x09, 0x03);	//wwj add

    sccb_write(SLAVE_ID, 0x3d, 0x03);
    sccb_write(SLAVE_ID, 0x17, 0x22);
    sccb_write(SLAVE_ID, 0x18, 0xa4);
    sccb_write(SLAVE_ID, 0x19, 0x07);
    sccb_write(SLAVE_ID, 0x1a, 0xf0);
    sccb_write(SLAVE_ID, 0x32, 0x00);
    sccb_write(SLAVE_ID, 0x29, 0xa0);
    sccb_write(SLAVE_ID, 0x2c, 0xf0);
    sccb_write(SLAVE_ID, 0x2a, 0x00);
    sccb_write(SLAVE_ID, 0x11, 0x01); // ;00/01/03/07 for 60/30/15/7.5fps
    ...
    sccb_write(SLAVE_ID, 0x13, 0xf0);
    sccb_write(SLAVE_ID, 0x0d, 0x71); // ;51/61/71 for different AEC/AGC window	//wwj modify
    sccb_write(SLAVE_ID, 0x0f, 0xc5);
    sccb_write(SLAVE_ID, 0x14, 0x11);
    //	sccb_write(SLAVE_ID,0x22,0x98);// ;ff/7f/3f/1f for 60/30/15/7.5fps
    sccb_write(SLAVE_ID, 0x22, 0x39); // ;ff/7f/3f/1f for 60/30/15/7.5fps
    sccb_write(SLAVE_ID, 0x23, 0x02); // ;01/03/07/0f for 60/30/15/7.5fps	//03->02 for fps < 30 issue
    sccb_write(SLAVE_ID, 0x24, 0x60);
    sccb_write(SLAVE_ID, 0x25, 0x50);
    sccb_write(SLAVE_ID, 0x26, 0xa1);
    sccb_write(SLAVE_ID, 0x2b, 0x00); // ;00/9e for 60/50Hz
    sccb_write(SLAVE_ID, 0x6b, 0xaa);
    sccb_write(SLAVE_ID, 0x13, 0xff);
    ...
    sccb_write(SLAVE_ID, 0x94, 0xb0);
    sccb_write(SLAVE_ID, 0x95, 0x9d);
    sccb_write(SLAVE_ID, 0x96, 0x13);
    sccb_write(SLAVE_ID, 0x97, 0x16);
    sccb_write(SLAVE_ID, 0x98, 0x7b);
    sccb_write(SLAVE_ID, 0x99, 0x91);
    sccb_write(SLAVE_ID, 0x9a, 0x1e);
    sccb_write(SLAVE_ID, 0x9b, 0x08);
    sccb_write(SLAVE_ID, 0x9c, 0x20);
    sccb_write(SLAVE_ID, 0x9e, 0x81);
    sccb_write(SLAVE_ID, 0xa6, 0x04);

    //GAMMA
    /*	sccb_write(SLAVE_ID,0x7e,0x07);
    	sccb_write(SLAVE_ID,0x7f,0x10);
    	sccb_write(SLAVE_ID,0x80,0x23);
    	sccb_write(SLAVE_ID,0x81,0x43);
    	sccb_write(SLAVE_ID,0x82,0x5E);
    	sccb_write(SLAVE_ID,0x83,0x6F);
    	sccb_write(SLAVE_ID,0x84,0x7D);
    	sccb_write(SLAVE_ID,0x85,0x8A);
    	sccb_write(SLAVE_ID,0x86,0x94);
    	sccb_write(SLAVE_ID,0x87,0x9C);
    	sccb_write(SLAVE_ID,0x88,0xA5);
    	sccb_write(SLAVE_ID,0x89,0xB1);
    	sccb_write(SLAVE_ID,0x8A,0xC0);
    	sccb_write(SLAVE_ID,0x8B,0xD3);
    	sccb_write(SLAVE_ID,0x8C,0xE6);
    	sccb_write(SLAVE_ID,0x8d,0x20);// ;slop
    	*/
    sccb_write(SLAVE_ID, 0x7e, 0x04);
    sccb_write(SLAVE_ID, 0x7f, 0x0d);
    sccb_write(SLAVE_ID, 0x80, 0x19);
    sccb_write(SLAVE_ID, 0x81, 0x2e);
    sccb_write(SLAVE_ID, 0x82, 0x3c);
    sccb_write(SLAVE_ID, 0x83, 0x49);
    sccb_write(SLAVE_ID, 0x84, 0x55);
    sccb_write(SLAVE_ID, 0x85, 0x64);
    sccb_write(SLAVE_ID, 0x86, 0x6f);
    sccb_write(SLAVE_ID, 0x87, 0x7e);
    sccb_write(SLAVE_ID, 0x88, 0x91);
    sccb_write(SLAVE_ID, 0x89, 0xa3);
    sccb_write(SLAVE_ID, 0x8A, 0xbd);
    sccb_write(SLAVE_ID, 0x8B, 0xd3);
    sccb_write(SLAVE_ID, 0x8C, 0xe8);
    sccb_write(SLAVE_ID, 0x8d, 0x20); // ;slop


    sccb_write(SLAVE_ID, 0x33, 0x00);		//24Mhz 50Hz	//0x66 -> 0x00 for fps < 30 issue
    sccb_write(SLAVE_ID, 0x34, 0x00);		//24Mhz 50Hz
    sccb_write(SLAVE_ID, 0xac, 0xbf); // ;
    sccb_write(SLAVE_ID, 0x8e, 0x09); // ;de-noise 2010/07/19

    sccb_write(SLAVE_ID, 0xac, 0xdf); // ;sharpness
    sccb_write(SLAVE_ID, 0x8f, 0x01);

    sccb_write(SLAVE_ID, 0x0c, 0x20); //0xe0 //wwj modify

    //	night mode
    sccb_write(SLAVE_ID, 0x0e, 0x79); 	//night mode off

    sccb_write(SLAVE_ID, 0xa6, 0x02); //
    sccb_write(SLAVE_ID, 0xa7, 0x44); //USAT	0x40
    sccb_write(SLAVE_ID, 0xa8, 0x44); //VSAT	0x40

    //	sccb_write(SLAVE_ID,0x9c,0x26);//Contrast Gain 0x20
    ...
    sccb_write(SLAVE_ID, 0x11, 0x01); // fly 03
    sccb_write(SLAVE_ID, 0x0d, 0x81); // ;51/61/71 for different AEC/AGC window//c1

    sccb_write(SLAVE_ID, 0x2a, 0x00); //0x19//10
    sccb_write(SLAVE_ID, 0x2b, 0x9e); // ;00/9e for 60/50Hz//0x13

    sccb_write(SLAVE_ID, 0x13, 0xbf); //
    sccb_write(SLAVE_ID, 0x3e, 0xe6); //
    sccb_write(SLAVE_ID, 0x64, 0xff); //

    sccb_write(SLAVE_ID, 0x42, 0x7f); //
    sccb_write(SLAVE_ID, 0x4d, 0x09); //
    sccb_write(SLAVE_ID, 0x63, 0xf0); //e0

    sccb_write(SLAVE_ID, 0x65, 0x20); //
    sccb_write(SLAVE_ID, 0x66, 0x00); //
    sccb_write(SLAVE_ID, 0x67, 0x48); //48
    sccb_write(SLAVE_ID, 0x69, 0x5d); //

    sccb_write(SLAVE_ID, 0x33, 0xb3); //b3//00

    sccb_write(SLAVE_ID, 0x0f, 0xc5); //
    sccb_write(SLAVE_ID, 0x14, 0x11); //
    sccb_write(SLAVE_ID, 0x15, 0x02); //fly add
    sccb_write(SLAVE_ID, 0x09, 0x03); //fly
    sccb_write(SLAVE_ID, 0x0c, 0x20); //fly ++++0x90		//daniel add horizontal mirror

    /*	sccb_write(SLAVE_ID,0x22,0xab);// ;ff/7f/3f/1f for 60/30/15/7.5fps//7f*******ab//7e
    	sccb_write(SLAVE_ID,0x23,0x03);// ;01/03/07/0f for 60/30/15/7.5fps//07******03*/
    sccb_write(SLAVE_ID, 0x22, 0x8f); // ;ff/7f/3f/1f for 60/30/15/7.5fps//7f*******ab//7e
    sccb_write(SLAVE_ID, 0x23, 0x83); // ;01/03/07/0f for 60/30/15/7.5fps//07******03

    sccb_write(SLAVE_ID, 0x24, 0x40); //
    sccb_write(SLAVE_ID, 0x25, 0x30); //
    sccb_write(SLAVE_ID, 0x26, 0x51); //AEC Fast Mode Operating Region	//0xA1

    sccb_write(SLAVE_ID, 0x6b, 0xaa); //
    sccb_write(SLAVE_ID, 0x13, 0xf7); //0xef
    sccb_write(SLAVE_ID, 0x90, 0x05); //
    sccb_write(SLAVE_ID, 0x91, 0x01); //
    sccb_write(SLAVE_ID, 0x92, 0x03); //
    sccb_write(SLAVE_ID, 0x93, 0x00); //
    ...
    sccb_write(SLAVE_ID, 0x9a, 0x1e); //
    /*
    sccb_write(SLAVE_ID,0x9b,0x08);//////////////////////08
    sccb_write(SLAVE_ID,0x9c,0x20);//20
    	*/




    sccb_write(SLAVE_ID, 0xac, 0xff); //40

    sccb_write(SLAVE_ID, 0x9e, 0x81); //
    sccb_write(SLAVE_ID, 0xa6, 0x04); //
    sccb_write(SLAVE_ID, 0x7e, 0x0c); //
    sccb_write(SLAVE_ID, 0x7f, 0x16); //
    sccb_write(SLAVE_ID, 0x80, 0x2a); //
    sccb_write(SLAVE_ID, 0x81, 0x4e); //
    sccb_write(SLAVE_ID, 0x82, 0x61); //
    sccb_write(SLAVE_ID, 0x83, 0x6f); //
    sccb_write(SLAVE_ID, 0x84, 0x7b); //
    sccb_write(SLAVE_ID, 0x85, 0x86); //
    sccb_write(SLAVE_ID, 0x86, 0x8e); //
    sccb_write(SLAVE_ID, 0x87, 0x97); //
    sccb_write(SLAVE_ID, 0x88, 0xa4); //
    sccb_write(SLAVE_ID, 0x89, 0xaf); //
    sccb_write(SLAVE_ID, 0x8a, 0xc5); //
    sccb_write(SLAVE_ID, 0x8b, 0xd7); //
    sccb_write(SLAVE_ID, 0x8c, 0xe8); //
    sccb_write(SLAVE_ID, 0x8d, 0x20); //

    sccb_write(SLAVE_ID, 0xac, 0xdf); //

    sccb_write(SLAVE_ID, 0x8f, 0x05); //00 //09
    sccb_write(SLAVE_ID, 0x90, 0x08); //08

    sccb_write(SLAVE_ID, 0x92, 0x1f); //1f
    sccb_write(SLAVE_ID, 0x93, 0x01); //01

    sccb_write(SLAVE_ID, 0x9b, 0x0c); //Brightness Control 0x00

    sccb_write(SLAVE_ID, 0x9c, 0x29); //Contrast Gain 0x20

    sccb_write(SLAVE_ID, 0xa6, 0x06); //
    sccb_write(SLAVE_ID, 0xa7, 0x55); //USAT	0x40
    sccb_write(SLAVE_ID, 0xa8, 0x46); //VSAT	0x40

    sccb_write(SLAVE_ID, 0x37, 0x7B);
    sccb_write(SLAVE_ID, 0x38, 0x7B);

    sccb_write(SLAVE_ID, 0x3B, 0x7B);
    sccb_write(SLAVE_ID, 0x3C, 0x7B);

    sccb_write(SLAVE_ID, 0x44, 0x7B);
    sccb_write(SLAVE_ID, 0x45, 0x7B);
#endif
    //R_SPI0_CTRL = tmp;
...
)
{
    ...
    )
    {
        ...
        // Enable CSI clock to let sensor initialize at first
#if 1 //CSI_CLOCK == CSI_CLOCK_27MHZ
        uCtrlReg2 = CLKOEN | CSI_RGB565 | CLK_SEL27M | CSI_HIGHPRI | CSI_NOSTOP;
#else
        uCtrlReg2 = CLKOEN | CSI_RGB565 | CLK_SEL48M | CSI_HIGHPRI | CSI_NOSTOP;
#endif
        ...
        /////////////////guobin 20110408/////////////////////
        {
...
#if 1
            //*******30fps************
            sccb_write(SLAVE_ID, 0x01, 0x6a); //0x56);
            sccb_write(SLAVE_ID, 0x02, 0x70); //1f);
            sccb_write(SLAVE_ID, 0x0f, 0x00);
            sccb_write(SLAVE_ID, 0xe2, 0x00);
            sccb_write(SLAVE_ID, 0xe3, 0x96); //ad);
            sccb_write(SLAVE_ID, 0xe4, 0x02);
            sccb_write(SLAVE_ID, 0xe5, 0x58); //07);
            sccb_write(SLAVE_ID, 0xe6, 0x02);
            sccb_write(SLAVE_ID, 0xe7, 0x58); //07);
            sccb_write(SLAVE_ID, 0xe8, 0x02);
            sccb_write(SLAVE_ID, 0xe9, 0x58); //07);
            sccb_write(SLAVE_ID, 0xea, 0x02);
            sccb_write(SLAVE_ID, 0xeb, 0x58); //07);
            //			sccb_write(SLAVE_ID,0xec,0x20);
            ...
            sccb_write(SLAVE_ID, 0x3f, 0x00);
#endif
            sccb_write(SLAVE_ID, 0x50, 0x14); //12);
            sccb_write(SLAVE_ID, 0x53, 0x84);
            sccb_write(SLAVE_ID, 0x54, 0x80);
            sccb_write(SLAVE_ID, 0x55, 0x80);
            sccb_write(SLAVE_ID, 0x56, 0x84);
            ...
            sccb_write(SLAVE_ID,0xAF,0xFF);
            #endif*/
            sccb_write(SLAVE_ID, 0xb1 , 0x36); //40);
            sccb_write(SLAVE_ID, 0xb2 , 0x36); //40);
            sccb_write(SLAVE_ID, 0xbd , 0x3c);
            sccb_write(SLAVE_ID, 0xbe , 0x36);
            sccb_write(SLAVE_ID, 0xd0 , 0xc9);
            sccb_write(SLAVE_ID, 0xd1 , 0x10);
            sccb_write(SLAVE_ID, 0xd3 , 0x80);
            sccb_write(SLAVE_ID, 0xd5 , 0xf2);
            sccb_write(SLAVE_ID, 0xd6 , 0x10);
            sccb_write(SLAVE_ID, 0xdb , 0x92);
            sccb_write(SLAVE_ID, 0xdc , 0xa5);
            ...
            sccb_write(SLAVE_ID, 0x14 , 0x13); //10);
            sccb_write(SLAVE_ID, 0x23 , 0x00);
            sccb_write(SLAVE_ID, 0x2d , 0x0a);
            sccb_write(SLAVE_ID, 0x20 , 0xff);
            sccb_write(SLAVE_ID, 0xd2 , 0x90);
            sccb_write(SLAVE_ID, 0x73 , 0x00);
            sccb_write(SLAVE_ID, 0x77 , 0x54); //33);
            sccb_write(SLAVE_ID, 0xb3 , 0x44); //40);
            sccb_write(SLAVE_ID, 0xb4 , 0x80);
            sccb_write(SLAVE_ID, 0xba , 0x00);
            sccb_write(SLAVE_ID, 0xbb , 0x00);
    ...
    void CSI_Init (INT16S nWidthH, INT16S nWidthV, INT16U uFlag, INT32U uFrmBuf0, INT32U uFrmBuf1)
    {
        ...
        *P_CSI_TG_FBSADDR_B = uFrmBuf1;
...
#endif
#ifdef	__BF3925_DRV_C__
        BF3925_Init (nWidthH, nWidthV, uFlag);
#endif
#ifdef	__OV7725_DRV_C__
        ...
        gpio_init_io(VIDEO_ACTIVE_KEY, GPIO_INPUT);
        gpio_set_port_attribute(VIDEO_ACTIVE_KEY, ATTRIBUTE_LOW);
        gpio_write_io(VIDEO_ACTIVE_KEY, DATA_LOW);	//high active
    }
    //====================================================================================================
