...
INT16U storage_polling(void)		//storage detect
{
...
INT16U storage_usbd_detection(void)
{
    ...
    if (s_usbd_pin)
    {
        if(NAND1_EN == 1)
        {
            stg_init_val |= STG_CFG_NAND1;
        }
        if(SD_EN == 1)
        {
            stg_init_val |= STG_CFG_SD;
        }
        if(MSC_EN == 1)
        {
            stg_init_val |= STG_CFG_MS;
        }
        if(USB_NUM >= 1)
        {
            stg_init_val |= STG_CFG_USBH;
            stg_init_val |= STG_CFG_USBD;
        }
        if(CFC_EN == 1)
        {
            stg_init_val |= STG_CFG_CF;
        }
        if(XD_EN == 1)
        {
            stg_init_val |= STG_CFG_XD;
        }
