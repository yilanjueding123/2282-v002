...
/* add begin by Zhibo, 2017-05-08 连拍*/
...
#define SECRECY_ENABLE		1 //=0, 不加密; =1,开启加密

#define GUEST_NAME_2822


#define CAPTURE_KEY_SAVE_VIDEO			1
#define PRODUCT_NUM                     2282
#define PRODUCT_DATA                    20170506
#define PROGRAM_VERSION_NUM             1	//129
